...
<body>
	...
	<%      
           ...
           System.out.println("Evaluating date now after completion method");
           System.out.println("Date is  : " + date + "after completion method");
             
             
           out.println("Evaluating date now after completion method" );                            
           out.println("date : " + date + "after completion method");
  %>
